...
class TestPublicClient(object):
    ...
    @mark.parametrize("product,level",[
                                    ...
                                    ('BTC-USD', 2),
                                    (product(), 3)])
    def test_get_product_order_book(self, client, product, level):
    ...
    def test_get_product_ticker(self, client, product):
    ...
    def test_get_trades(self, client, product):
    ...
    def test_get_stats(self, client, product):
